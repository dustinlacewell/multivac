...
export function ChatArea(props: { onShowSettings: () => void, sx?: SxProps }) {
  ...
  const { apiKey, dbApiKey, chatModelId, systemPurposeId } = useSettingsStore(state => ({
    apiKey: state.apiKey, dbApiKey: state.dbApiKey, chatModelId: state.chatModelId, systemPurposeId: state.systemPurposeId,
  }));
